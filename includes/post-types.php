...
function cptui_register_my_cpts_google_reviews() {

	/**
	 * Post Type: Google Reviews.
	 */

	$labels = [
		"name" => __( "Google Reviews", "custom-post-type-ui" ),
		"singular_name" => __( "Google Review", "custom-post-type-ui" ),
	];

	$args = [
		"label" => __( "Google Reviews", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => [ "slug" => "google_reviews", "with_front" => true ],
		"query_var" => true,
