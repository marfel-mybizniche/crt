...
if ( get_field('page_header_options') !== 'no_header' ):
	...
	?>
		...
		?>
			...
			<?php endif; //  if( $banner_height == "medium_height" && !is_front_page()) : 
		endif;  // if( get_field('page_header_options') == "global_header_opt" || is_post_type_archive() || is_single() ):
	endif; // if(! strpos( $template, 'single-listings.php' )):
endif; // if ( get_field('page_header_options') !== 'no_header' ):
 ?>